-- =============================================================================
-- PowerDNS Authoritative - SQLite3 schema
-- Idempotent: every CREATE uses IF NOT EXISTS so re-runs of the role are safe
-- on databases that already contain zones/records.
-- Reference: https://doc.powerdns.com/authoritative/backends/generic-sqlite3.html
-- =============================================================================
